...
public class SwfWriter
{
    ...
    public void Write(Swf swf)
    {
        ...
        // write tags data
        var tags = swf.Tags.GetEnumerator();
        while (tags.MoveNext())
        {
            var tagToWrite = (BaseTag)tags.Current;
    ...
    public string FileName
    {
        ...
        {
            fileName = value;
            baseStream = new FileStream(fileName, FileMode.Create);
        }
    }
