/*
	...
	writted by Florian Kr�sch Copyright (C) 2004 .
...
internal abstract class EndianBitConverter
{
    ...
    public int SingleToInt32Bits(float value) =>
        new Int32SingleUnion(value).AsInt32;
    ...
    public float Int32BitsToSingle(int value) =>
        new Int32SingleUnion(value).AsSingle;
    ...
    private static void CheckByteArgument(byte[] value, int startIndex, int bytesRequired)
    {
        ...
        if (startIndex < 0 || startIndex > value.Length - bytesRequired) throw new ArgumentOutOfRangeException("startIndex");
    }
    ...
    public byte[] GetBytes(double value) =>
        GetBytes(DoubleToInt64Bits(value), 8);
    ...
    public byte[] GetBytes(float value) =>
        GetBytes(SingleToInt32Bits(value), 4);
