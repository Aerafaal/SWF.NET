...
public abstract class BaseAction
{
	...
	///     Action codes are enumerated in <see cref="ActionCode" />
	/// </summary>
	public readonly int Code;

	/// <summary>
	///     byte count, calculated during compilation for <seealso cref="MultiByteAction">multibyte actions</seealso>
	/// </summary>
    ...
    ///     public constructor
    /// </summary>
    /// <param name="c">action code as occuring in swf. Codes are listed in this <see cref="ActionCode">enumeration</see></param>
