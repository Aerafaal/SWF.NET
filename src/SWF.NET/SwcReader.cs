...
public class SwcReader
{
    ...
    private readonly ZipFile swcFile;
    ...
    public Swc ReadSwc()
    {
        ...
        var zipEntries = new ArrayList();

        var enumerator = swcFile.GetEnumerator();
        while (enumerator.MoveNext())
        {
            var zipEntry = (ZipEntry)enumerator.Current;
