...
public class ScriptLimitTag : BaseTag
{
    ...
    /// <param name="timeout">
    ///     Specified timeout. That's the maximum time, in seconds, that a sequence of actions will execute before the Flash Player present a dialog box asking whether
    ...
    /// </summary>
    public ushort Recursion { get; set; }
