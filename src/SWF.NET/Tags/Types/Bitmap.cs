...
public class BitmapColorData
{
    ...
    public BitmapColorData(Pix15[] bitmapPixelData) =>
        bitmapPixelDataPix15 = bitmapPixelData;
    ...
    public BitmapColorData(Pix24[] bitmapPixelData) =>
        bitmapPixelDataPix24 = bitmapPixelData;
    ...
    {
        if (bitmapPixelDataPix15 != null)
            foreach (var pix in bitmapPixelDataPix15)
                pix.WriteTo(writer);
        else if (bitmapPixelDataPix24 != null)
            foreach (var pix in bitmapPixelDataPix24)
                pix.WriteTo(writer);
    }
