...
public class DefineFontTag : BaseTag, DefineTag, IDefineFont
{
    ...
    protected void Init()
    {
        GlyphShapesTable = new GlyphShapesCollection();
        _tagCode = (int)TagCodeEnum.DefineFont;
    }
    ...
    /// </summary>
    public GlyphShapesCollection GlyphShapesTable { get; private set; }
    ...
    public override void ReadData(byte version, BufferedBinaryReader binaryReader)
    {
        ...
        var firstOffset = binaryReader.ReadUInt16();
        var nGlyhs = Convert.ToInt32(Math.Ceiling((double)firstOffset / 2));

        offsetTable = new ushort[nGlyhs];
        offsetTable[0] = firstOffset;
        for (var i = 1; i < nGlyhs; i++)
    ...
    public override void UpdateData(byte version)
    {
        ...
        if (offsetTable != null)
        {
            var offsets = offsetTable.GetEnumerator();
