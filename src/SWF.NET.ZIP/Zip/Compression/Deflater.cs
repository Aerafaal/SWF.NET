...
public class Deflater
{
    ...
    * The Deflater can do the following state transitions:
    ...
    private static readonly int INIT_STATE = 0x00;
    ...
    /// </summary>
    private readonly bool noHeaderOrFooter;
    ...
    public bool IsFinished =>
        state == FINISHED_STATE && pending.IsFlushed;
    ...
    {
        if ((state & IS_FINISHING) != 0) throw new InvalidOperationException("finish()/end() already called");
    ...
    public void SetLevel(int lvl)
    {
        if (lvl == DEFAULT_COMPRESSION)
            lvl = 6;
        else if (lvl < NO_COMPRESSION || lvl > BEST_COMPRESSION) throw new ArgumentOutOfRangeException("lvl");
    ...
    public int Deflate(byte[] output) =>
        Deflate(output, 0, output.Length);
