...
public class DeflaterOutputStream : Stream
{
	...
	public bool CanPatchEntries =>
        baseOutputStream.CanSeek;

	/// <summary>
	///     Gets value indicating stream can be read from
	/// </summary>
	public override bool CanRead =>
        baseOutputStream.CanRead;
	...
	public override long Position
    {
        ...
        set =>
            throw
                ...
                new NotSupportedException("DefalterOutputStream Position not supported");
    }
    ...
    protected void Deflate()
    {
        while (!def.IsNeedingInput)
        {
            ...
            if (Password != null) EncryptBlock(buf, 0, len);

            baseOutputStream.Write(buf, 0, len);
        }

        if (!def.IsNeedingInput) throw new ApplicationException("DeflaterOutputStream can't deflate all input?");
    }
