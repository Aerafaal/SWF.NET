...
public class DeflaterHuffman
{
    ...
    public static short BitReverse(int toReverse) =>
        (short)((bit4Reverse[toReverse & 0xF] << 12) |
    ...
    public class Tree
    {
        ...
        public void CheckEmpty()
        {
            ...
            if (!empty) throw new ApplicationException("!Empty");
        ...
        public void BuildCodes()
        {
            ...
            if (DeflaterConstants.DEBUGGING && code != 65536) throw new ApplicationException("Inconsistent bl_counts!");
        ...
        public void BuildTree()
        {
            ...
            */
            ...
            if (heap[0] != childs.Length / 2 - 1) throw new ApplicationException("Heap invariant violated");
